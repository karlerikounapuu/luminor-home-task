...
class ItemStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_status" do
    assert_difference("ItemStatus.count") do
      post item_statuses_url, params: { item_status: { active: @item_status.active, description: @item_status.description, name: "Maintenance" } }
    end

    assert_response :redirect
    assert_match %r{/item_statuses/[0-9a-f-]+}, @response.location
  end
  ...
  test "should update item_status" do
    patch item_status_url(@item_status), params: { item_status: { active: @item_status.active, description: @item_status.description, name: @item_status.name } }
  ...
  test "should destroy item_status" do
    ...
    @item_status.configuration_items.destroy_all
